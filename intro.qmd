...
- **Next 72 hours:** Hack on stuff! Minimum four hours of effort. "Rules" on the next slide.
  - Zoom office hours on Wednesday and Thursday
  - We'll be continuously monitoring `r slack_channel`
  - We recommend that you not team up; we prefer that you work on individual projects, and ask for help/feedback in the slack channel
- **Friday:** Show & tell, share lessons learned, reflections.
- **Post-hackathon:** Create/deploy an LLM-enabled Shiny app for your company. We can help!
:::

## Hack On Stuff {.smaller}
