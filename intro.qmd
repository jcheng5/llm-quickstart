...
- Before we begin, please join `#hackathon-02` in Slack!
...
- Sending proprietary code/data to _local_ models is also fine. Ask in `#hackathon-02` if you need help setting up a local model.
