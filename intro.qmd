...
- Before we begin, please join `#hackathon-01` in Slack!
...
- Sending proprietary code/data to _local_ models is also fine. Ask in `#hackathon-01` if you need help setting up a local model.
