...
- **Gemini 2.0 Pro**: 2 million token context length
...
- Examples
  - [Ellmer assistant](https://github.com/jcheng5/elmer-assistant/blob/main/prompt.generated.md) uses README files in prompt
