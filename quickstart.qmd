...
- Grab your OpenAI API key; see the thread in `#hackathon-01`

- For R
  - `pak::pak(c("hadley/elmer", "dotenv"))`
- For Python
...
- R: [`elmer` docs](https://github.com/hadley/elmer?tab=readme-ov-file#tool-calling-aka-function-calling) (anticlimactically easy)
...
# Customizing knowledge and behavior
...
## API access for open weight models
...
- Prompt stuffing (putting information in a prompt)
  - Shiny Assitant:
    - <https://github.com/posit-dev/shiny-assistant/blob/main/app_prompt.md>
    - <https://github.com/posit-dev/shiny-assistant/blob/main/app_prompt_python.md>
  - FastHTML: <https://docs.fastht.ml/llms-ctx.txt>
