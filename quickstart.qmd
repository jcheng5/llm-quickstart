...
- Grab your OpenAI API key; see the thread in `#hackathon-03`
...
- Ask [Shiny asssistant](https://gallery.shinyapps.io/shiny-assistant/) for help (ping me or Winston if you need us to approve your invite)
...
- [Posit.cloud workspace](https://posit.cloud/spaces/564193/join?access_code=HFgo5wTL-yjjlV4v4bLbh9Hm9g6-0eiAqRbms4Sa) with some examples
  - Contains [LLM chat examples](https://github.com/wch/llm-chat) in R
...
Ask `#hackathon-03` for help if you're stuck! (Or ask ChatGPT/Claude to make an example.)