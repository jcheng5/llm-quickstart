...
- For R: `install.packages(c("ellmer", "shinychat", "dotenv", "shiny"))`
...
- Ask [Shiny assistant](https://gallery.shinyapps.io/assistant/) for help
...
- Can access API via [OpenAI](https://platform.openai.com/docs/overview/) or [Azure](https://azure.microsoft.com/en-us/products/ai-services/openai-service)

## Anthropic models

- **Claude 3.7 Sonnet**: best model for code generation
- **Claude 3.5 Sonnet**: previous best model for code generation; some still prefer it over 3.7
- **Claude 3.5 Haiku**: faster, cheaper (and dumber) than Sonnet
- Can access API via [Anthropic](https://docs.anthropic.com/) or [AWS Bedrock](https://aws.amazon.com/bedrock/claude/) <!--([instructions for using Bedrock at Posit](https://positpbc.atlassian.net/wiki/spaces/SE/pages/1376550915/Using+Claude+via+Bedrock+at+Posit))-->
...
- Can also access these models via API with [OpenRouter](https://openrouter.ai/), [Groq](https://groq.com/), [AWS Bedrock](https://aws.amazon.com/bedrock/llama/)

## DeepSeek models

- Open weights
- Can access via API from [DeepSeek](https://platform.deepseek.com/), [OpenRouter](https://openrouter.ai/deepseek/deepseek-r1)
- Can run locally, for example with [Ollama](https://ollama.com/)
...
- **Photography:** Evaluate photos for focus issues. Auto-generate photo title, tags, and description. Advanced OCR on specific document types.
- **Gaming:** Dungeon master for D&D campaign. Agent for navigating simple ASCII maze.
- **Data:** Tool for auto-generating ALT tags for plots. Tool for making realistic-looking mock datasets. Code linter for R and PyData code. Dataset exploring assistant.
