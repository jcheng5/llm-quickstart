...
- Python:
  ...
  - [`PydanticAI`](https://ai.pydantic.dev/) - relatively new (announced 2024-12), abstracts over providers, relatively low level. (Does not support streaming for Anthropic!)
  - [`langchain`](https://python.langchain.com/docs/introduction/) - high-level, all models, sprawling scope... but polarizing architecture, steep learning curve, and supposedly questionable code quality
    - Evolved from v0.1, v0.2, and now [`langgraph`](https://langchain-ai.github.io/langgraphjs/)
...
- [Shiny Assistant](https://gallery.shinyapps.io/assistant/) on the web can't help you with `ui.Chat` for data privacy reasons
...
- Standard protocol to give LLMs access to tools
- Tool can be implemented by third party as MCP server
- The application that talks to LLM is an MCP client
- [Clients](https://modelcontextprotocol.io/clients): Claude Desktop app, Claude Code, Continue, Cursor
- Example [Servers](https://github.com/modelcontextprotocol/servers)
  - [Filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) - Give LLM access to files on disk
  - [Github](https://github.com/modelcontextprotocol/servers/blob/main/src/github)
