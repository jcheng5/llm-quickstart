...
- Open weights
- Can run locally, for example with [Ollama](https://ollama.com/)
- **DeepSeek R1 671b** 404GB (claimed similar perf to OpenAI o1)
- **DeepSeek R1 32b, 70b** 20GB, 43GB (claimed similar perf to OpenAI o1-mini)
- Smaller sizes also available
- Can also access via API from [DeepSeek](https://platform.deepseek.com/), [OpenRouter](https://openrouter.ai/deepseek/deepseek-r1), [Hugging Face](https://huggingface.co/docs/api-inference/en/index)
