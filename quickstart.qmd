...
- Examples
  - Shiny Assitant:
    - [Main prompt](https://github.com/posit-dev/shiny-assistant/blob/main/app_prompt.md)
    - [Python supplement](https://github.com/posit-dev/shiny-assistant/blob/main/app_prompt_python.md)
